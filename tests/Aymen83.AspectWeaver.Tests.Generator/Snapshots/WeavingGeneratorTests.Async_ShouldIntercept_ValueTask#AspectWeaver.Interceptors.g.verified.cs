...
namespace Aymen83.AspectWeaver.Generated
{
    ...
    internal static class Interceptors
    {
        ...
        private static class Interceptor0_Cache
        {
            ...
            {
                return new global::AsyncAspectAttribute();
            }
            ...
            private static MethodInfo InitMethodInfo()
            {
                ...
                var methodInfo = __targetType.GetMethod("DoWorkValueAsync", BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance, null, __paramTypes, null);
                if (methodInfo == null) throw new global::System.InvalidOperationException("Could not resolve MethodInfo for DoWorkValueAsync during initialization.");
                return methodInfo;
            }
