    ...
    internal static class Interceptors
    {
        ...
        private static class Interceptor0_Cache
        {
            ...
            private static MethodInfo InitMethodInfo()
            {
                ...
                var __genericMethodDefinition = __targetType.GetMethod("Process", BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance, null, __paramTypes, null);
                if (__genericMethodDefinition == null) throw new global::System.InvalidOperationException("Could not resolve Generic Method Definition for Process during initialization.");
