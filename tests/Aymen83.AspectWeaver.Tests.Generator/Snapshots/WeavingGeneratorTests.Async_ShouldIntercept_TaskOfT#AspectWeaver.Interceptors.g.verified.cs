...
namespace Aymen83.AspectWeaver.Generated
{
    ...
    internal static class Interceptors
    {
        ...
        private static class Interceptor0_Cache
        {
            ...
            {
                return new global::AsyncAspectAttribute("ConfigValue") { Order = 5 };
            }
            ...
            private static MethodInfo InitMethodInfo()
            {
                ...
                var methodInfo = __targetType.GetMethod("CalculateAsync", BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance, null, __paramTypes, null);
                if (methodInfo == null) throw new global::System.InvalidOperationException("Could not resolve MethodInfo for CalculateAsync during initialization.");
                return methodInfo;
            }
