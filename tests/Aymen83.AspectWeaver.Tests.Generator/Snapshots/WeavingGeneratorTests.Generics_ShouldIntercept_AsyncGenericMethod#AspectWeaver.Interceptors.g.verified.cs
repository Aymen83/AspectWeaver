...
namespace Aymen83.AspectWeaver.Generated
{
    ...
    internal static class Interceptors
    {
        ...
        internal static async global::System.Threading.Tasks.Task<T> InterceptMethod0<T>(this global::TestApp.AsyncGenericService __instance, string key) where T : struct
        {
            ...
            var __arguments = new Interceptor0_Cache.ArgumentsStruct(key);
        ...
        private static class Interceptor0_Cache
        {
            public readonly struct ArgumentsStruct : global::Aymen83.AspectWeaver.Abstractions.IArgumentsContainer
            {
                ...
                public ArgumentsStruct(global::System.String key)
                {
                    _key = key;
                }
                ...
                {
                    yield return new global::System.Collections.Generic.KeyValuePair<string, object?>("key", _key);
                }
            ...
            private static MethodInfo InitMethodInfo()
            {
                ...
                var __genericMethodDefinition = __targetType.GetMethod("FetchAsync", BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance, null, __paramTypes, null);
                if (__genericMethodDefinition == null) throw new global::System.InvalidOperationException("Could not resolve Generic Method Definition for FetchAsync during initialization.");
