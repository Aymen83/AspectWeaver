...
namespace AspectWeaver.Extensions.Validation
{
    ...
    {
        // This handler does not require DI, so the constructor is empty.
        ...
        public async ValueTask<TResult> InterceptAsync<TResult>(ValidateParametersAttribute attribute, InvocationContext context, Func<InvocationContext, ValueTask<TResult>> next)
        {
            ...
            foreach (var parameterInfo in parameters)
            {
                ...
                // We rely on the dictionary key matching the parameter name.
                ...
                // Note: If the argument is missing from the dictionary, it indicates an issue in the generator (should not happen).
            }
